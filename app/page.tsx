...
const skills = ["Captação profissional", "Direção", "Iluminação", "Captação de áudio", "Adobe Premiere Pro", "CapCut", "Vídeos verticais", "Reels", "Conteúdo comercial", "Storytelling", "Operação de gimbal", "Fotografia"];
...
export default function Home() {
  return (
    <main>
      ...
      <section className="work-section section-shell" id="trabalhos" aria-labelledby="work-title"><div className="section-heading"><div className="work-title-wrap"><p className="eyebrow">01 / Seleção</p><h2 id="work-title"><span className="work-title-line">TRABALHOS</span><span className="work-title-line"><em>SELECIONADOS</em></span></h2></div><p className="section-lead">Projetos fictícios que serão substituídos por histórias reais. Cada produção nasce de um olhar atento ao ritmo, à luz e ao propósito.</p></div><div className="project-list">{projects.map((project, index) => <ProjectCard key={project.title} project={project} index={index} />)}</div></section>
