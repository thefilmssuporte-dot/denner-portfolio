  ...
  return (
    <main>
      <header className="site-header">
        ...
        <nav className="desktop-nav" aria-label="Navegação principal"><a href="#trabalhos">Trabalhos</a><a href="#sobre">Sobre</a><a href="#competencias">Competências</a><a href="#contato">Contato</a><a className="nav-resume" href="tel:+5515997401512">+55 15 99740-1512 <span aria-hidden="true">↗</span></a></nav>
        <details className="mobile-menu"><summary aria-label="Abrir menu">Menu <span aria-hidden="true">+</span></summary><nav aria-label="Navegação mobile"><a href="#trabalhos">Trabalhos</a><a href="#sobre">Sobre</a><a href="#competencias">Competências</a><a href="#contato">Contato</a><a href="tel:+5515997401512">+55 15 99740-1512</a></nav></details>
      </header>
